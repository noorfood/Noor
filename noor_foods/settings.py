...
load_dotenv() # Loads environment variables from .env if it exists
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'procurement.context_processors.pending_actions',
            ],
        },
    },
]

WSGI_APPLICATION = 'noor_foods.wsgi.application'
...
NOOR_WARNING_MAX_LOSS_PCT = 18.0
